...
const FEDEX_TRACK_URL = 'https://apis.fedex.com/track/v1/associatedshipments';

export async function POST(req: NextRequest) {
    try {
        const { masterTrackingNumber } = await req.json();
        ...
        // 2. Call Tracking API
        const trackRes = await fetch(FEDEX_TRACK_URL, {
            method: 'POST',
            headers: {
